...
(7, '2021_08_02_070232_create_student_classes_table', 2),
(8, '2021_08_02_160626_create_subjects_table', 3),
(9, '2014_10_12_200000_add_two_factor_columns_to_users_table', 4),
(10, '2019_12_14_000001_create_personal_access_tokens_table', 4),
(11, '2021_08_02_162238_create_sessions_table', 4),
(13, '2021_08_05_081552_create_students_table', 5);
...
('8mMQXRkHWngYoMBPus3u4ByYgPydrEEaUtd3lJvg', NULL, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/92.0.4515.107 Safari/537.36', 'YTozOntzOjY6Il90b2tlbiI7czo0MDoiOEIwbzhRVE1HOFNoeFBUZHFtYUN4T0RaT1dpRFg2N3VVSERBQWNaMyI7czo5OiJfcHJldmlvdXMiO2E6MTp7czozOiJ1cmwiO3M6MjE6Imh0dHA6Ly8xMjcuMC4wLjE6ODAwMCI7fXM6NjoiX2ZsYXNoIjthOjI6e3M6Mzoib2xkIjthOjA6e31zOjM6Im5ldyI7YTowOnt9fX0=', 1627965370),
...
INSERT INTO `students` (`id`, `student_class_id`, `subject_id`, `name`, `fname`, `mname`, `photo`, `created_at`, `updated_at`) VALUES
(1, 1, 1, 'testname', 'test', 'test', 'upload/student/code.png', NULL, NULL),
(2, 1, 1, 'testname1', 'test2', 'test2', 'upload/student/code.png', NULL, NULL),
(3, 1, 1, 'testname1', 'test2', 'test2', 'upload/student/code.png', NULL, NULL);
...
(1, 'Nine', '2021-08-02 07:05:34', NULL),
(2, 'Ten', '2021-08-02 07:22:18', NULL),
(3, 'Eleven', NULL, NULL),
(4, 'Twelve', NULL, NULL),
(6, 'eight', NULL, NULL);
...
INSERT INTO `subjects` (`id`, `student_class_id`, `subject_name`, `subject_code`, `created_at`, `updated_at`) VALUES
(1, 1, 'Higher Math', '100', '2021-08-02 16:19:51', '2021-08-03 01:20:28'),
(2, 1, 'Math', '103', NULL, NULL),
(3, 2, 'Physics', '104', NULL, NULL),
(4, 2, 'Chemistry', '105', NULL, NULL);
